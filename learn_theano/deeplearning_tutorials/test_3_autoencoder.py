...
def autoencoder(input, n_visible, n_hidden, rng):
    w_init = rng.uniform(
...
if __name__ == "__main__":
    run_3_denoising_autoencoder(corruption_level=0.3)
    '''
    Mean costs at epoch 249 is 64.072647% (ran for 6.7s)
The training code run 1681.6s, for 249 epochs, for with 0.148070 epochs/sec
    '''
